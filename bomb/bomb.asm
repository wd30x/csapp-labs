...
0000000000400ee0 <phase_1>:
  ...
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal> # make (rdi) == (rsi)
  400eee:	85 c0                	test   %eax,%eax                  # make eax == 0 to defuse
...
0000000000400efc <phase_2>:
  ...
  400f0e:	74 20                	je     400f30 <phase_2+0x34>    # jump to line 375
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax    # eax = 1st argu, eax = 2st argu
  400f1a:	01 c0                	add    %eax,%eax    # eax *= 2
  400f1c:	39 03                	cmp    %eax,(%rbx)    # compare 2*eax with (rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>    # jump to line 371
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>    
  400f25:	48 83 c3 04          	add    $0x4,%rbx    # rbx = 3rd argu
  400f29:	48 39 eb             	cmp    %rbp,%rbx    # not equal
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>    # jump to line 366
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx   # rbx = 2nd argu
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp    # rbp = skip+56
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>    # jump to line 366
...
0000000000400f43 <phase_3>:
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>    # jump to line 393 
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)   # compare 1st with 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # explode
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax   # eax = 1st argu
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)   # jump to *0x402470 + rax * 8
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax   # switch statement
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax   # make eax == rsp + 12
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax    # eax = edx (eax == 14)
  400fd4:	29 f0                	sub    %esi,%eax    # eax = eax - esi
  400fd6:	89 c1                	mov    %eax,%ecx    # ecx = eax
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx   # >>> 31 get highest bit of rcx
  400fdb:	01 c8                	add    %ecx,%eax    # eax = eax + ecx
  400fdd:	d1 f8                	sar    %eax   # eax >> 1 (eax / 2)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   # ecx = rax + rsi
  400fe2:	39 f9                	cmp    %edi,%ecx    # ecx <= edi (edi 是第一个arg，ecx好像是eax的一半)
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>    # jump to line 438

  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx    # edx = rcx - 1(每次递归eax / 2 - 1)
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>   # recursive call
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>    # exit func

  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax    # eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx    # ecx >= edi
  400ff9:	7d 0c                	jge    401007 <func4+0x39>    # exit func

  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi   # esi = rcx + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>   # recursive call
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax  # explode when eax == 1
...
000000000040100c <phase_4>:
  ...
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi   # edi = 1st argu
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax    # rax should be 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)   # 2nd argu should be 0
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp   # allocate 24 bits
  ...
  40148f:	83 f8 05             	cmp    $0x5,%eax    # eax > 0x5
